...
if PW[1] == "" then gg.alert("🐣Hello Glorious🐣") os.exit() end
if PW[1] =="5555" then 
 gg.toast('🐣Glorious🐣')
else 
 gg.alert("WRONG PASSWORD!") return end
gg.alert("🐣Hello Glorious🐣 ")
...
"〰️┣[M249] By Glorious 🐣     ●",
"〰️┣[Lewis]By Glorious 🐣      ●",
"〰️┣[Black Pistol]By Glorious 🐣 ●",
"〰️┣[Mini14-Semi-M24-K31] By Glorious 🐣    ●",
"〰️┣[ShotGun] By Glorious 🐣  ●",
"〰️┣[Pistol] By Glorious 🐣     ●",
"🐣Back🐣",
}, nil,"┣【Have a good day】┫")
if SN5 == 1 then
M4()
